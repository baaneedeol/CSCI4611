...
export class App extends gfx.GfxApp
{
    ...
    createScene(): void 
    {
        ...
        const directionalLight = new gfx.DirectionalLight(new Vector3(1.5, 1.5, 1.5));
    ...
    {
        if (event.buttons == 1) {
            this.earth.mouseRotation.multiply(Quaternion.makeRotationX(event.movementY *  0.01));
        }
    }
