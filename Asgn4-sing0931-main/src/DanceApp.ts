...
{    
    ...
    createScene(): void 
    {
        ...
        const ambientLight = new gfx.AmbientLight(new Vector3(0.3, 0.3, 0.3));
        this.scene.add(ambientLight);

        // Create a directional light
        const directionalLight = new gfx.DirectionalLight(new Vector3(0.6, 0.6, 0.6));
    ...
    onSkeletonsAndMotionClipsLoaded(): void
    {
        ...
        this.balletDanceMotions[1].trimBack(250);

        this.balletDanceMotions[2].trimFront(180);
        this.balletDanceMotions[2].trimBack(220);

        this.balletDanceMotions[3].trimFront(150);
        this.balletDanceMotions[3].trimBack(180);
